...
const productTemplates = [
  ...
  {
    name: "ยาแก้ไอน้ำเชื่อม",
    generic: "Guaifenesin Syrup",
    brand: "Mucosolvan",
    type: "otc",
    price: 125,
    color: "fce7f3/be185d",
...
export const MOCK_PRODUCTS: Product[] = productTemplates.map((t, i) => {
  ...
  const stocks = [
    500, 200, 300, 8, 50, 150, 0, 120, 80, 200, 75, 15, 95, 140, 60, 85, 110,
    175, 130, 90, 180, 220, 70, 160, 100, 250, 65, 190, 145, 210,
  ];
  return {
    id: `prod-${num}`,
    name: t.name,
