    ...
    items: [
      {
        id: "oi-001",
        product_id: "prod-002",
        product_name: "อะม็อกซีซิลลิน 500 mg",
        product_image: "https://placehold.co/80x80/fef3c7/d97706?text=Amox",
        sku: "AMOX-500-002",
        quantity: 3,
        unit_price: 120,
        role_id: "retail",
      },
      {
        id: "oi-002",
        product_id: "prod-001",
        product_name: "พาราเซตามอล 500 mg",
        product_image: "https://placehold.co/80x80/e0f7f4/0d9488?text=Para",
        sku: "PARA-500-001",
        quantity: 2,
        unit_price: 25,
        role_id: "retail",
    ...
    items: [
      {
        id: "oi-003",
        product_id: "prod-009",
        product_name: "เมทฟอร์มิน 500 mg",
        product_image: "https://placehold.co/80x80/e0f2fe/0284c7?text=Met",
        sku: "MET-500-009",
        quantity: 20,
        unit_price: 80,
        role_id: "clinic",
      },
      {
        id: "oi-004",
        product_id: "prod-008",
        product_name: "โอเมพราโซล 20 mg",
        product_image: "https://placehold.co/80x80/fff7ed/ea580c?text=Ome",
        sku: "OME-20-008",
        quantity: 10,
        unit_price: 175,
        role_id: "clinic",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "oi-006",
        product_id: "prod-003",
        product_name: "วิตามิน C 1000 mg",
        product_image: "https://placehold.co/80x80/fce7f3/db2777?text=VitC",
        sku: "VITC-1000-003",
        quantity: 30,
        unit_price: 130,
        role_id: "wholesale",
  ...
  },
  {
    ...
    items: [
      {
        id: "oi-007",
        product_id: "prod-006",
        product_name: "ครีมซันสกรีน SPF50+",
        product_image: "https://placehold.co/80x80/f3e8ff/7c3aed?text=Sun",
        sku: "SUN-50-006",
        quantity: 1,
        unit_price: 420,
        role_id: "retail",
    ...
    status_logs: [
      ...
      },
      {
        from: "confirmed",
        to: "shipped",
        changed_at: "2026-04-02T09:00:00Z",
        note: "",
      },
      {
        from: "shipped",
        to: "completed",
        changed_at: "2026-04-04T14:00:00Z",
        note: "ลูกค้ายืนยันรับสินค้า",
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        id: "oi-009",
        product_id: "prod-010",
        product_name: "โอเมก้า-3 1000 mg",
        product_image: "https://placehold.co/80x80/f0fdf4/16a34a?text=Omg",
        sku: "OMG-1000-010",
        quantity: 1,
        unit_price: 290,
        role_id: "retail",
    ...
    status_logs: [
      ...
      },
      {
        from: "pending",
        to: "cancelled",
        changed_at: "2026-04-10T15:00:00Z",
        note: "เปลี่ยนใจ ขอยกเลิก",
      },
    ],
