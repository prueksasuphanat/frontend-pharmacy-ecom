...
import { MOCK_NOTIFICATIONS, MOCK_ADMIN_NOTIFICATIONS } from '@/mocks/users'
import { useAuthStore } from './auth.store'
import type { Notification } from '@/mocks/users'
...
export const useNotificationStore = defineStore('notification', () => {
  ...
  return {
    notifications, unreadCount, latest5, isOpen,
    loadMockNotifications, startPolling, stopPolling,
    markRead, markAllRead, toggle, close,
  }
})
