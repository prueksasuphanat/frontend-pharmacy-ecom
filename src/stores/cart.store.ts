...
export const useCartStore = defineStore('cart', () => {
  ...
  const hasPrescriptionItem = computed(() => items.value.some(i => i.requires_prescription))
  ...
  return {
    items, totalItems, subtotal, shippingFee, total, hasPrescriptionItem,
    addToCart, updateQty, removeItem, clearCart, moveToWishlist,
  }
})
