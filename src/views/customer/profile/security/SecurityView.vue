...
async function onSubmit() {
  ...
  try {
    const res = await apiClient.patch<{ success: boolean; message: string }>("/customer/profile/password", {
    ...
    errorMsg.value = err.response?.data?.message || "ไม่สามารถเปลี่ยนรหัสผ่านได้ กรุณาลองใหม่อีกครั้ง";
  } finally {
