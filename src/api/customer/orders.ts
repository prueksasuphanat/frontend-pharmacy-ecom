 ...
 * GET    /api/v1/customer/orders          → getOrders()
 * GET    /api/v1/customer/orders/:id      → getOrderById()
 * PATCH  /api/v1/customer/orders/:id/cancel → cancelOrder()
 */
...
export const ordersApi = {
  ...
  cancel: (id: number, reason?: string) =>
    apiClient.patch<OrderApiResponse>(`/customer/orders/${id}/cancel`, { reason }),
};
